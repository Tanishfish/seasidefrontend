...
<div dangerouslySetInnerHTML={{ __html: content.description }} />
    ...
    <p style={{
       ...
       For all bookings and Casting enquiries please contact <Link to="info@seasidekids.co.uk" style={{color:"##23cdfe", textDecoration:"none"}}>info@seasidekids.co.uk</Link> or call us at <Link to="07896904920" style={{color:"##23cdfe", textDecoration:"none"}}> 07896904920</Link><br/>
      For Representation please go to our join us page.
      </p>
    </div>
    </>
  )
